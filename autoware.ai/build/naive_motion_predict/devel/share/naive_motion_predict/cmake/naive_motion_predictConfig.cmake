...
if("TRUE" STREQUAL "TRUE")
  set(naive_motion_predict_SOURCE_PREFIX /home/capstone/autoware.ai/src/autoware/core_perception/naive_motion_predict)
  set(naive_motion_predict_DEVEL_PREFIX /home/capstone/autoware.ai/build/naive_motion_predict/devel)
  ...
  set(naive_motion_predict_INSTALL_PREFIX /home/capstone/autoware.ai/install/naive_motion_predict)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naive_motion_predict' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/capstone/autoware.ai/src/autoware/core_perception/naive_motion_predict/${idir}'.  ${_report}")
    endif()
