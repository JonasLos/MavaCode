...
if("TRUE" STREQUAL "TRUE")
  set(hokuyo_SOURCE_PREFIX /home/capstone/autoware.ai/src/drivers/awf_drivers/hokuyo)
  set(hokuyo_DEVEL_PREFIX /home/capstone/autoware.ai/build/hokuyo/devel)
  set(hokuyo_INSTALL_PREFIX "")
  set(hokuyo_PREFIX ${hokuyo_DEVEL_PREFIX})
else()
  set(hokuyo_SOURCE_PREFIX "")
  set(hokuyo_DEVEL_PREFIX "")
  set(hokuyo_INSTALL_PREFIX /home/capstone/autoware.ai/install/hokuyo)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hokuyo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/capstone/autoware.ai/src/drivers/awf_drivers/hokuyo/${idir}'.  ${_report}")
    endif()
